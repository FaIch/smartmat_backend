...
```
cd existing_repo
git remote add origin https://gitlab.stud.idi.ntnu.no/joakifa/idatt2106_2023_11_backend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.stud.idi.ntnu.no/joakifa/idatt2106_2023_11_backend/-/settings/integrations)
