...
class SubUserRequestTest {
    ...
    void testAllArgsConstructor() {
        SubUserRequest request = new SubUserRequest("test@example.com", "TestNickname", Role.PARENT);
    ...
    void testEqualsAndHashCode() {
        SubUserRequest request1 = new SubUserRequest("test@example.com", "TestNickname", Role.PARENT);
        SubUserRequest request2 = new SubUserRequest("test@example.com", "TestNickname", Role.CHILD);
        SubUserRequest request3 = new SubUserRequest("test@example.com", "TestNickname2", Role.PARENT);
        SubUserRequest request4 = new SubUserRequest("test@example.com", "TestNickname", Role.PARENT);
